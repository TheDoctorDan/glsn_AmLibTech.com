...
public class Subsystem extends Database_Record_Base {
    ...
    throws Database_Front_Exception, Database_Record_Constructor_Exception, Database_Front_No_Results_Exception {
        ...
        try{
            ...
            if(debug_Mode){
                message = "Connection to ALT_ASP Database Failed. Database_Front_Exception :" + dbfe.getMessage();
        ...
        try {
            ...
            if(debug_Mode){
                message = "Failed to find Subsystem(" +subsystem_Id +") in database. Database_Front_Exception :" + dbfe.getMessage();
                throw new Database_Front_Exception(message);
            }else{
                throw dbfe;
            }
            ...
            if(debug_Mode){
                message = "Failed to find Subsystem(" +subsystem_Id +") in database. Database_Front_No_Results_Exception :" + dbfe.getMessage();
        ...
        try{
            ...
            if(debug_Mode){
                message = "Close of Connection to ALT_ASP DataBase Failed. Database_Front_Exception :" + dbfe.getMessage();
                throw new Database_Front_Exception(message);
            }else{
                throw dbfe;
            }
