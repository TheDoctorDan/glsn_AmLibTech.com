    ...
    throws ServletException, IOException {
        ...
        if(subscriber_Organization_Portal==null){
            ...
            if(subscriber_Organization_Portal.getKiosk_Mode().getValue().booleanValue()){
                ...
                out.println("<form id='error' name='error' method='post' action='" + subscriber_Organization_Portal.getWeb_Root() + subscriber_Organization_Portal.getDestination_Url().getValue()+ "'>");
