...
public class Web_Process {
    ...
    public synchronized void error_End(String message, Exception ex) {
        ...
        if(this.subscriber_Organization_Portal.getKiosk_Mode().getValue().booleanValue()){
            ...
            out.println("       <form id='error_end' name='error_end' method='post' action='" + this.getSubscriber_Organization_Portal().getWeb_Root()+
            "/Launcher_Servlet'>");
    ...
    public synchronized void error(String message, Exception ex) {
        ...
        if(this.subscriber_Organization_Portal.getKiosk_Mode().getValue().booleanValue()){
            ...
            out.println("       <form id='error' name='error' method='post' action='" + this.getSubscriber_Organization_Portal().getWeb_Root()+
            "/Launcher_Servlet'>");
